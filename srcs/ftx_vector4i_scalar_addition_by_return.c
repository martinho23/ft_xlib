 ...
 * =====================================================================================
 *
 *       Filename:  ftx_vector4i_scalar_addition_by_return.c
 *
 *    Description:  Function that adds a scalar value to all of vector dimentions of t_ftx_vector3i
 *        (a int 4 dimentional vector) and return the result, the value vec is a const pointer to
...
t_ftx_vector4i ftx_vector4i_scalar_addition_by_return(const t_ftx_vector4i *vec, const int scalar)
{
	...
	ftx_vector4i_scalar_addition(vec, scalar, &tmp);
